export const translations = {
  en: {
    vendingMachines: {
      ...
      lightOff: "Light OFF",
      o3OnSec: "OZON ON (sec)",
      o3OffSec: "OZON OFF (sec)",
      o3OnDesc: "Ozone injection into the tank per cycle",
      o3OffDesc: "Interval between ozone injections into the tank",
      // Analytics
      analytics: "Analytics",
...
o3OnDesc: "Время подачи озона в бак за один цикл",
o3OffDesc: "Интервал между циклами подачи озона в бак",
...
o3OnDesc: "Czas podawania ozonu do zbiornika w jednym cyklu",
o3OffDesc: "Przerwa między cyklami podawania ozonu do zbiornika",
      detail: "Parametry",
