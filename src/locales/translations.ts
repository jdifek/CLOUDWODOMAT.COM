...
statusOff: "Off",
      ...
      powerOn: "Turn on",
      powerOff: "Turn off",
      calibrationTitle: "Price calibration (timer mode)",
      calibPrice: "Price",
      calibWater: "Liters",
      calibrateSubmit: "Calibrate",
      tempMax: "Max Temp (°C)",
      tempAlert: "Temp Alert",
      lightOn: "Light ON",
      lightOff: "Light OFF",
      o3OnSec: "OZONE ON (sec)",
      o3OffSec: "OZONE OFF (sec)",
      o3OnDesc: "OZONE ON (sec) — ozone supply time to tank.",
      o3OffDesc: "OZONE OFF (sec) — ozone supply period to tank.",
      // Analytics
      analytics: "Analytics",
      analyticsTerminal: "Terminal",
      analyticsQr: "QR",
      analyticsCard: "IC Card",
      analyticsCardDesc: "path = shop / card payment",
      analyticsCash: "Cash",
      analyticsPeriodDay: "Day",
      analyticsPeriodWeek: "Week",
      analyticsPeriodMonth: "Month",
      analyticsPeriod3Months: "3 mo.",
      analyticsRevenue: "Revenue",
      analyticsTransactions: "transactions",
      analyticsAvgTicket: "Avg. ticket",
      analyticsWaterVolume: "Water volume",
      analyticsPort1: "Port 1",
      analyticsPort2: "Port 2",
      analyticsTotal: "Total",
      analyticsRevenueChart: "Revenue",
      analyticsWaterChart: "Water volume",
      analyticsPerHour: "by hour",
      analyticsPerDay: "by day",
      analyticsPaymentTypes: "Payment types",
      analyticsTerminalDesc: "pay_id ends with _pos",
      analyticsQrDesc: "path contains «qr»",
      analyticsCashDesc: "coins / other",
      analyticsLastInspection: "Last inspection",
      analyticsWaterMeterLabel: "Water meter",
      analyticsRecoveryRate: "Recovery rate",
      analyticsRawWater: "Raw water",
      analyticsSaleWater: "Purified water",
      analyticsEleUsed: "Electricity (period)",
      analyticsDayEle: "Electricity (daily)",
      analyticsLoadedRecords: "Loaded records",
      analyticsPeriodRecords: "For period",
      analyticsNoData: "No data",
      analyticsNoTransactions: "No transactions today.",
      analyticsNoTransactionsPeriod: "No transactions for selected period.",
      analyticsLoadingData: "Loading device data...",
      analyticsLoadingNote:
        "API doesn't support device filter — loading all records and filtering locally",
      analyticsPages: "p.",

      // Create order form (Recharges tab)
      createOrder: "Create order",
      createOrderTitle: "New order",
      createOrderValue: "Amount (min. 0.1)",
      createOrderUserId: "User ID",
      createOrderChannel: "Channel (optional)",
      createOrderSubmit: "Create",
      createOrderCreating: "Creating...",
      createOrderSuccess: "Order created! Waiting for device confirmation...",
      createOrderError: "Order creation error",
      createOrderStatusFinished: "✅ Device received the command",
      createOrderStatusFailed: "❌ Order failed",
      createOrderStatusCancel: "❌ Order cancelled",
      createOrderStatusWaiting: "⏳ Waiting for device response...",
      createOrderOrderId: "Order ID",
      details: "Details",
      inspections: "Inspections",
      consumption: "Receipts",
      recharges: "Water Balance",
      ...
      sensors: "Sensors",
      tds: "TDS",
      pricesAndLimits: "Settings Changes",
      port1Price: "Port 1 Price (per L)",
      port2Price: "Port 2 Price (per L)",
      txLimitPort1: "Transaction Limit (Port 1)",
      txLimitPort2: "Transaction Limit (Port 2)",
      dayLimit: "Day Limit",
      flowParams: "Flow Parameters",
      flowMeter: "Flow Meter Parameter",
      waterTimePort1: "Water Time (Port 1)",
      waterTimeLiterPort2: "Water Time (Port 2, L)",
      waterTimeControlPort2: "Water Time (Port 2, Control)",
      geolocation: "Geolocation",
      latGcj02: "Latitude (gcj02)",
      lngGcj02: "Longitude (gcj02)",
      latDevice: "Latitude (device)",
      lngDevice: "Longitude (device)",
      dualPort: "Dual Port Support",
      yes: "Yes",
      no: "No",
      inspectionNo: "Inspection #",
      waterMeter: "Water Meter",
      rawWater: "Raw Water (L)",
      purifiedWater: "Purified Water (L)",
      recoveryRate: "Recovery Rate",
      eleMeter: "Electricity Meter",
      eleUsed: "Electricity Used (kWh)",
      intervalDays: "Interval (days)",
      dayEleUsed: "Daily Electricity Used",
      inspector: "Inspector",
      note: "Note",
      noInspections: "No inspections found",
      noConsumption: "No Receipts records found",
      noRecharges: "No recharge records found",
      ...
      method: "Method",
      waterPort1: "Water Port 1 (L)",
      waterPort2: "Water Port 2 (L)",
      address: "Address",
      cardNumber: "Card Number",
      operator: "Operator",
      credited: "Credited (with discount)",
      type: "Type",
      viaOpenApi: "Via Open API",
      paymentNumber: "Payment Number",
      loadMore: "Load More",
      // IC Cards tab
      cards: "IC Cards",
      openCards: "Open Cards",
      openCardsSubmit: "Open",
      cardStartNumber: "Start Card Number",
      cardCount: "Count",
      noCards: "No cards found",
      cardStatusNormal: "Active",
      cardStatusLost: "Lost",
      cardStatusCancel: "Cancelled",
      cardBalance: "Balance (bonus)",
      cardCash: "Balance (cash)",
      cardOwner: "Owner",
      cardCreated: "Created",
      cardPolicy: "Plan",
      cardExpiry: "Expires",
      ...
      cardUnblock: "Unblock",
      recharge: "Top up",
      rechargeCard: "Top up card",
      rechargeValue: "Top-up amount",
      rechargeIncome: "Actual income",
      rechargeSubmit: "Top up",
      saving: "Saving...",
    },
    auth: {
    ...
    subscription: {
      noDevicesError: "Please add at least one device before subscribing.",
      checkoutError: "Failed to create checkout session",
      addDevicesFirst: "Please add at least one device before subscribing.",
      ...
      basePricePerDevice: "Base Price per Device",
    ...
    admin: {
      ...
      basePriceDescription:
        "This price will be multiplied by the number of devices for each subscription.",
      exampleCalculation: "Example Calculation",
      device: "device",
      warning: "Warning",
      priceChangeWarning:
        "Changing the base price will affect all new subscriptions. Existing subscriptions will keep their current price.",
    ...
    recharge: {
      ...
      autoPackageInfo:
        "After entering the number, the package will be displayed automatically",
      return: "Return",
    ...
    dashboard: {
      ...
      periodCard: "IC Card (period)",
      periodCash: "Cash (period)",
      periodQr: "QR (period)",
      periodPayments: "Payment types (period)",
      devicesOnline: "Devices online",
      hourly: "By hour",
      daily: "By day",
      periodStats: "Period statistics",
      todayCard: "IC Card (today)",
      todayCash: "Cash (today)",
      todayQr: "QR (today)",
      ...
      subscriptionData: "KPI Indicators for the Period",
      ...
      todayPayments: "Payment types (today)",
    },
    common: {
      minAgo: "min ago",
      hAgo: "h",
    ...
    isCards: {
      ...
      notifyDesc:
        "Sends the card balance to the device, equivalent to physically swiping the card.",
      card: "Card",
      device: "Device",
      selectDevice: "Select device",
      ...
      isCardsNoDeviceRestrictionsWorksOnAllDevices:
  ...
  ru: {
    isCards: {
      ...
      notifyDesc:
        "Отправляет баланс карты на устройство, аналог физического считывания.",
      card: "Карта",
      device: "Устройство",
      ...
      isCardsNoDeviceRestrictionsWorksOnAllDevices:
        "Нет ограничений по устройствам — работает на всех устройствах",
...
statusOff: "Выключено",
      ...
      powerOn: "Включить",
      powerOff: "Выключить",
      calibrationTitle: "Калибровка цены (режим хронометража)",
      calibPrice: "Цена",
      calibWater: "Литры",
      calibrateSubmit: "Откалибровать",
      tempMin: "Темп. мин (°C)",
      tempMax: "Темп. макс (°C)",
      tempAlert: "Алерт темп.",
      lightOn: "Свет ВКЛ",
      lightOff: "Свет ВЫКЛ",
      o3OnSec: "ОЗОН ON (сек)",
      o3OffSec: "ОЗОН OFF (сек)",
      o3OnDesc: "ОЗОН ВКЛ. (сек) — время озона в бак.",
      o3OffDesc: "ОЗОН ВЫКЛ. (сек) — период подачи озона в бак.",
      analyticsCard: "IC Карта",
      analyticsCardDesc: "path = shop / оплата картой",
      analyticsTerminal: "Терминал",
      analyticsQr: "QR",
      analyticsCash: "Наличные",
      analytics: "Аналитика",
      analyticsPeriodDay: "День",
      analyticsPeriodWeek: "Неделя",
      analyticsPeriodMonth: "Месяц",
      analyticsPeriod3Months: "3 мес.",
      analyticsRevenue: "Выручка",
      analyticsTransactions: "транзакций",
      analyticsAvgTicket: "Средний чек",
      analyticsWaterVolume: "Объём воды",
      analyticsPort1: "Порт 1",
      analyticsPort2: "Порт 2",
      analyticsTotal: "Итого",
      analyticsRevenueChart: "Выручка",
      analyticsWaterChart: "Объём воды",
      analyticsPerHour: "по часам",
      analyticsPerDay: "по дням",
      analyticsPaymentTypes: "Типы оплат",
      analyticsTerminalDesc: "pay_id оканчивается на _pos",
      analyticsQrDesc: "path содержит «qr»",
      analyticsCashDesc: "монеты / прочее",
      analyticsLastInspection: "Последняя инспекция",
      analyticsWaterMeterLabel: "Счётчик воды",
      analyticsRecoveryRate: "Коэф. восстановления",
      analyticsRawWater: "Сырая вода",
      analyticsSaleWater: "Чистая вода",
      analyticsEleUsed: "Эл-во за период",
      analyticsDayEle: "Эл-во в день",
      analyticsLoadedRecords: "Загружено записей",
      analyticsPeriodRecords: "За период",
      analyticsNoData: "Нет данных",
      analyticsNoTransactions: "Нет транзакций за сегодня.",
      analyticsNoTransactionsPeriod: "Нет транзакций за выбранный период.",
      analyticsLoadingData: "Загрузка данных устройства...",
      analyticsLoadingNote:
        "API не поддерживает фильтр по устройству — загружаем все записи и фильтруем локально",
      analyticsPages: "стр.",

      // Форма создания заказа (вкладка Пополнения)
      createOrder: "Создать заказ",
      createOrderTitle: "Новый заказ",
      createOrderValue: "Сумма (мин. 0.1)",
      createOrderUserId: "ID пользователя",
      createOrderChannel: "Канал (опционально)",
      createOrderSubmit: "Создать",
      createOrderCreating: "Создание...",
      createOrderSuccess: "Заказ создан! Ожидаем подтверждения устройства...",
      createOrderError: "Ошибка создания заказа",
      createOrderStatusFinished: "✅ Устройство получило команду",
      createOrderStatusFailed: "❌ Заказ не выполнен",
      createOrderStatusCancel: "❌ Заказ отменён",
      ...
      seller: "Продавец (saler)",
      lastConnection: "Последнее подключение",
      sensors: "Датчики",
      tds: "TDS",
      pricesAndLimits: "Изменение настроек",
      port1Price: "Цена — порт 1 (за л)",
      port2Price: "Цена — порт 2 (за л)",
      txLimitPort1: "Лимит транзакции (порт 1)",
      txLimitPort2: "Лимит транзакции (порт 2)",
      dayLimit: "Дневной лимит",
      flowParams: "Параметры потока",
      flowMeter: "Параметр расходомера",
      waterTimePort1: "Время воды (порт 1)",
      waterTimeLiterPort2: "Время воды (порт 2, литр)",
      waterTimeControlPort2: "Время воды (порт 2, контроль)",
      geolocation: "Геолокация",
      latGcj02: "Широта (gcj02)",
      lngGcj02: "Долгота (gcj02)",
      latDevice: "Широта (устройство)",
      lngDevice: "Долгота (устройство)",
      dualPort: "Поддержка 2 портов",
      yes: "Да",
      no: "Нет",
      inspectionNo: "Инспекция #",
      waterMeter: "Счётчик воды",
      rawWater: "Сырая вода (л)",
      purifiedWater: "Очищ. вода (л)",
      recoveryRate: "Коэф. восст.",
      eleMeter: "Счётчик эл.",
      eleUsed: "Потр. эл. (кВт·ч)",
      intervalDays: "Интервал (дни)",
      dayEleUsed: "Дн. потр. эл.",
      inspector: "Инспектор",
      note: "Примечание",
      noInspections: "Инспекций не найдено",
      noConsumption: "Записей потребления не найдено",
      noRecharges: "Записей пополнений не найдено",
      paymentType: "Тип оплаты",
      terminal: "Терминал",
      cash: "Наличные",
      paymentId: "ID платежа",
      amount: "Сумма",
      charged: "Списано (факт)",
      balanceAfter: "Остаток после",
      method: "Метод",
      waterPort1: "Вода порт 1 (л)",
      waterPort2: "Вода порт 2 (л)",
      address: "Адрес",
      cardNumber: "Номер карты",
      operator: "Оператор",
      credited: "Зачислено (со скидкой)",
      type: "Тип",
      viaOpenApi: "Через Open API",
      paymentNumber: "Номер платежа",
      loadMore: "Загрузить ещё",
      // Вкладка ИС-Карты
      cards: "IC-Карты",
      openCards: "Открыть карты",
      openCardsSubmit: "Открыть",
      cardStartNumber: "Начальный номер",
      cardCount: "Количество",
      noCards: "Карты не найдены",
      cardStatusNormal: "Активна",
      cardStatusLost: "Утеряна",
      cardStatusCancel: "Отменена",
      cardBalance: "Баланс (бонус)",
      cardCash: "Баланс (нал.)",
      cardOwner: "Владелец",
      cardCreated: "Создана",
      cardPolicy: "Тариф",
      cardExpiry: "Действует до",
      cardBlock: "Заблокировать",
      cardUnblock: "Разблокировать",
      recharge: "Пополнить",
      rechargeCard: "Пополнение карты",
      rechargeValue: "Сумма пополнения",
      rechargeIncome: "Реальный приход",
      rechargeSubmit: "Пополнить",
      saving: "Сохранение...",
    },
    auth: {
    ...
    subscription: {
      noDevicesError:
        "Пожалуйста, добавьте хотя бы одно устройство перед подпиской.",
      checkoutError: "Не удалось создать сеанс оплаты",
      addDevicesFirst:
        "Пожалуйста, добавьте хотя бы одно устройство перед подпиской.",
      ...
      numberOfDevices: "Количество устройств",
      basePricePerDevice: "Базовая цена за устройство",
    ...
    admin: {
      ...
      basePriceDescription:
        "Эта цена будет умножена на количество устройств для каждой подписки.",
      exampleCalculation: "Пример расчета",
      device: "устройство",
      warning: "Внимание",
      priceChangeWarning:
        "Изменение базовой цены повлияет на все новые подписки. Существующие подписки сохранят свою текущую цену.",
    ...
    dashboard: {
      ...
      todayQr: "QR (сег.)",
      periodCard: "IC Карта (период)",
      periodCash: "Наличные (период)",
      periodQr: "QR (период)",
      periodPayments: "Типы оплат за период",
      devicesOnline: "Устройства онлайн",
      hourly: "По часам",
      daily: "По дням",
      todayLiters: "Литры сегодня",
      ...
      subscriptionData: "Показатели KPI за период",
  ...
  pl: {
    isCards: {
      ...
      notifyDesc:
        "Wysyła saldo karty do urządzenia, odpowiednik fizycznego przyłożenia.",
      card: "Karta",
      device: "Urządzenie",
      ...
      isCardsNoDeviceRestrictionsWorksOnAllDevices:
        "Brak ograniczeń urządzeń — działa na wszystkich urządzeniach",
    ...
    vendingMachines: {
      statusOn: "Włączone",
statusOff: "Wyłączone",
      control: "Sterowanie urządzeniem",
      powerOn: "Włącz",
      powerOff: "Wyłącz",
      calibrationTitle: "Kalibracja ceny (tryb czasowy)",
      calibPrice: "Cena",
      calibWater: "Litry",
      calibrateSubmit: "Kalibruj",
      tempMin: "Temp min (°C)",
      tempMax: "Temp max (°C)",
      tempAlert: "Alarm temp.",
      lightOn: "Światło ON",
      lightOff: "Światło OFF",
      o3OnSec: "OZON ON (sek)",
      o3OffSec: "OZON OFF (sek)",
      o3OnDesc: "OZON WŁ. (sek) — czas ozonu do zbiornika.",
      o3OffDesc: "OZON WYŁ. (sek) — okres podawania ozonu do zbiornika.",
      analyticsCard: "Karta IC",
      analyticsCardDesc: "path = shop / płatność kartą",
      analyticsTerminal: "Terminal",
      analyticsQr: "QR",
      analyticsCash: "Gotówka",
      analytics: "Analityka",
      analyticsPeriodDay: "Dzień",
      analyticsPeriodWeek: "Tydzień",
      analyticsPeriodMonth: "Miesiąc",
      analyticsPeriod3Months: "3 mies.",
      analyticsRevenue: "Przychód",
      analyticsTransactions: "transakcji",
      analyticsAvgTicket: "Średni rachunek",
      analyticsWaterVolume: "Objętość wody",
      analyticsPort1: "Port 1",
      analyticsPort2: "Port 2",
      analyticsTotal: "Łącznie",
      analyticsRevenueChart: "Przychód",
      analyticsWaterChart: "Objętość wody",
      analyticsPerHour: "według godzin",
      analyticsPerDay: "według dni",
      analyticsPaymentTypes: "Typy płatności",
      analyticsTerminalDesc: "pay_id kończy się na _pos",
      analyticsQrDesc: "ścieżka zawiera «qr»",
      analyticsCashDesc: "monety / inne",
      analyticsLastInspection: "Ostatnia inspekcja",
      analyticsWaterMeterLabel: "Licznik wody",
      analyticsRecoveryRate: "Wsp. odzysku",
      analyticsRawWater: "Surowa woda",
      analyticsSaleWater: "Czysta woda",
      analyticsEleUsed: "Energii za okres",
      analyticsDayEle: "Energii dziennie",
      analyticsLoadedRecords: "Załadowane rekordy",
      analyticsPeriodRecords: "Za okres",
      analyticsNoData: "Brak danych",
      analyticsNoTransactions: "Brak transakcji na dziś.",
      analyticsNoTransactionsPeriod: "Brak transakcji za wybrany okres.",
      analyticsLoadingData: "Ładowanie danych urządzenia...",
      analyticsLoadingNote:
        "API nie obsługuje filtra urządzenia — ładujemy wszystkie rekordy i filtrujemy lokalnie",
      analyticsPages: "str.",

      // Formularz tworzenia zamówienia
      createOrder: "Utwórz zamówienie",
      createOrderTitle: "Nowe zamówienie",
      createOrderValue: "Kwota (min. 0.1)",
      createOrderUserId: "ID użytkownika",
      createOrderChannel: "Kanał (opcjonalnie)",
      createOrderSubmit: "Utwórz",
      createOrderCreating: "Tworzenie...",
      createOrderSuccess:
        "Zamówienie utworzone! Oczekiwanie na potwierdzenie urządzenia...",
      createOrderError: "Błąd tworzenia zamówienia",
      createOrderStatusFinished: "✅ Urządzenie otrzymało polecenie",
      createOrderStatusFailed: "❌ Zamówienie nieudane",
      createOrderStatusCancel: "❌ Zamówienie anulowane",
      createOrderStatusWaiting: "⏳ Oczekiwanie na odpowiedź urządzenia...",
      createOrderOrderId: "ID zamówienia",
      details: "Szczegóły",
      inspections: "Inspekcje",
      consumption: "Paragony",
      recharges: "Bilans wodny",
      statusSection: "Status",
      ...
      sensors: "Czujniki",
      tds: "TDS",
      pricesAndLimits: "Zmiana ustawień",
      port1Price: "Cena — port 1 (za L)",
      port2Price: "Cena — port 2 (za L)",
      txLimitPort1: "Limit transakcji (port 1)",
      txLimitPort2: "Limit transakcji (port 2)",
      dayLimit: "Dzienny limit",
      flowParams: "Parametry przepływu",
      flowMeter: "Parametr przepływomierza",
      waterTimePort1: "Czas wody (port 1)",
      waterTimeLiterPort2: "Czas wody (port 2, litr)",
      waterTimeControlPort2: "Czas wody (port 2, kontrola)",
      geolocation: "Geolokalizacja",
      latGcj02: "Szerokość (gcj02)",
      lngGcj02: "Długość (gcj02)",
      latDevice: "Szerokość (urządzenie)",
      lngDevice: "Długość (urządzenie)",
      dualPort: "Obsługa 2 portów",
      yes: "Tak",
      no: "Nie",
      inspectionNo: "Inspekcja #",
      waterMeter: "Licznik wody",
      rawWater: "Surowa woda (L)",
      purifiedWater: "Oczyszczona woda (L)",
      recoveryRate: "Wsp. odzysku",
      eleMeter: "Licznik prądu",
      eleUsed: "Zużycie prądu (kWh)",
      intervalDays: "Interwał (dni)",
      dayEleUsed: "Dzienne zużycie prądu",
      inspector: "Inspektor",
      note: "Uwaga",
      noInspections: "Nie znaleziono inspekcji",
      noConsumption: "Nie znaleziono zapisów zużycia",
      noRecharges: "Nie znaleziono doładowań",
      paymentType: "Typ płatności",
      terminal: "Terminal",
      cash: "Gotówka",
      paymentId: "ID płatności",
      amount: "Kwota",
      charged: "Pobrano (faktycznie)",
      balanceAfter: "Saldo po",
      method: "Metoda",
      waterPort1: "Woda port 1 (L)",
      waterPort2: "Woda port 2 (L)",
      address: "Adres",
      cardNumber: "Numer karty",
      operator: "Operator",
      credited: "Zaksięgowano (ze zniżką)",
      type: "Typ",
      ...
      cardCount: "Ilość",
      noCards: "Nie znaleziono kart",
      cardStatusNormal: "Aktywna",
      cardStatusLost: "Zgubiona",
      cardStatusCancel: "Anulowana",
      cardBalance: "Saldo (bonus)",
      cardCash: "Saldo (gotówka)",
      cardOwner: "Właściciel",
      cardCreated: "Utworzono",
      cardPolicy: "Plan",
      cardExpiry: "Ważna do",
      cardBlock: "Zablokuj",
      ...
      rechargeValue: "Kwota doładowania",
      rechargeIncome: "Faktyczny przychód",
      rechargeSubmit: "Doładuj",
      saving: "Zapisywanie...",
    },
    auth: {
    ...
    subscription: {
      noDevicesError: "Dodaj co najmniej jedno urządzenie przed subskrypcją.",
      checkoutError: "Nie udało się utworzyć sesji płatności",
      addDevicesFirst: "Dodaj co najmniej jedno urządzenie przed subskrypcją.",
      ...
      period1Month: "1 miesiąc",
      period6Months: "6 miesięcy",
      period12Months: "12 miesięcy",
      discount: "Zniżka",
    ...
    admin: {
      ...
      basePriceDescription:
        "Ta cena zostanie pomnożona przez liczbę urządzeń dla każdej subskrypcji.",
      exampleCalculation: "Przykład obliczenia",
      device: "urządzenie",
      warning: "Ostrzeżenie",
      priceChangeWarning:
        "Zmiana ceny bazowej wpłynie na wszystkie nowe subskrypcje. Istniejące subskrypcje zachowają swoją obecną cenę.",
    ...
    dashboard: {
      ...
      today: "Dziś",
      periodCard: "Karta IC (okres)",
      periodCash: "Gotówka (okres)",
      periodQr: "QR (okres)",
      periodPayments: "Typy płatności (okres)",
      devicesOnline: "Urządzenia online",
      hourly: "Godzinowo",
      daily: "Dziennie",
      periodStats: "Statystyki za okres",
      todayCard: "Karta IC (dziś)",
      todayCash: "Gotówka (dziś)",
      todayQr: "QR (dziś)",
      todayLiters: "Litry dziś",
      ...
      subscriptionData: "Wskaźniki KPI za okres",
