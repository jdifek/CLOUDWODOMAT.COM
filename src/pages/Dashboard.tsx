    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg p-6 shadow-sm">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-semibold text-gray-900">{t('dashboard.subscriptionData')}</h2>
          <button className="px-4 py-2 bg-[#4A90E2] text-white rounded hover:bg-[#3A7BC8] transition-colors">
        ...
        <ResponsiveContainer width="100%" height={300}>
          <LineChart data={lineChartData}>
            ...
            <Tooltip />
            <Legend />
            <Line type="monotone" dataKey="subscriptions" stroke="#4A90E2" name={t('dashboard.subscriptions')} />
            <Line type="monotone" dataKey="sales" stroke="#5CB85C" name={t('dashboard.sales')} />
            <Line type="monotone" dataKey="revenue" stroke="#F0AD4E" name={t('dashboard.revenue')} />
          </LineChart>
        </ResponsiveContainer>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="bg-white rounded-lg p-6 shadow-sm">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">{t('dashboard.loadingStats')}</h3>
          <ResponsiveContainer width="100%" height={200}>
            <PieChart>
              <Pie data={pieData1} cx="50%" cy="50%" outerRadius={80} fill="#8884d8" dataKey="value" label>
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">{t('dashboard.equipmentSettings')}</h3>
          <ResponsiveContainer width="100%" height={200}>
            <PieChart>
              <Pie data={pieData2} cx="50%" cy="50%" outerRadius={80} fill="#8884d8" dataKey="value" label>
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">{t('dashboard.glasswareSettings')}</h3>
          <ResponsiveContainer width="100%" height={200}>
            <PieChart>
              <Pie data={pieData3} cx="50%" cy="50%" outerRadius={80} fill="#8884d8" dataKey="value" label>
      ...
      <div className="bg-white rounded-lg p-6 shadow-sm">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">{t('dashboard.equipmentSequence')}</h3>
